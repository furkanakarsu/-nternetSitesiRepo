<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminDeneyimGuncelle.aspx.cs" Inherits="BlogSitesi.AdminDeneyimGuncelle" %>
    ...
    <form id="Form" runat="server">
        <div class="form-group">
             <div>
                ...
                <asp:TextBox ID="txtID" runat="server" CssClass="form-control" Width="1000px"></asp:TextBox>
            </div>
            <br />
            <div>
            ...
            <br />
              ...
              <div>
                ...
                <asp:TextBox ID="txtAciklama" runat="server" CssClass="form-control" Height="83px" TextMode="MultiLine" Width="1000px"></asp:TextBox>
            </div>
                 <br />
              <div>
